            ...
            <div className="row align-items-center">
                ...
                <div className="col-6 pl-5">
                    <div style={{width: 520, height: 410}}>
                        <img src={ImgHero} alt="Room with couches" className="img-fluid position-absolute" style={{margin: '-30px 0 0 -30px', zIndex: 1}} />
                        <img src={ImgHero_} alt="Room with couches frame" className="img-fluid position-absolute" style={{margin: '0 -15px -15px 0'}} />
                    </div>
                </div>
            </div>
        </section>
